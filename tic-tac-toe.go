...
func print_game(grid [9]int) {
	fmt.Println("+-----+-----+-----+		+-----+-----+-----+")
	fmt.Println("|  " + disp(grid[0]) + "  |  " + disp(grid[1]) + "  |  " + disp(grid[2]) + "  |		|  1  |  2  |  3  |")
	fmt.Println("+-----+-----+-----+		+-----+-----+-----+")
	fmt.Println("|  " + disp(grid[3]) + "  |  " + disp(grid[4]) + "  |  " + disp(grid[5]) + "  |		|  4  |  5  |  6  |")
	fmt.Println("+-----+-----+-----+		+-----+-----+-----+")
	fmt.Println("|  " + disp(grid[6]) + "  |  " + disp(grid[7]) + "  |  " + disp(grid[8]) + "  |		|  7  |  8  |  9  |")
	fmt.Println("+-----+-----+-----+		+-----+-----+-----+")
}
